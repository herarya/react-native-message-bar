...
class MessageBar extends Component {
  ...
  getStateByProps (props) {
    ...
    return {
      ...
      viewTopOffset: props.viewTopOffset || def.viewTopOffset || 20,
      viewBottomOffset: props.viewBottomOffset || def.viewBottomOffset || 10,
      viewLeftOffset: props.viewLeftOffset || def.viewLeftOffset || 10,
      viewRightOffset: props.viewRightOffset || def.viewRightOffset || 10,

      /* Inset of the view, useful if you want to apply a padding at your alert content */
      viewTopInset: props.viewTopInset || def.viewTopInset || 5,
      viewBottomInset: props.viewBottomInset || def.viewBottomInset || 5,
  ...
  renderImage () {
    if (this.state.avatar != null) {
      ...
      if(this.state.iconShow){
        ...
        switch (alertType) {
          case 'success':
              defaultImageSource = require('./images/checked.png')
            break
          case 'error':
              defaultImageSource = require('./images/error.png')
            break
          case 'warning':
              defaultImageSource = require('./images/warning.png');
            break
          case 'info':
              defaultImageSource = require('./images/exclamation.png');
            break
          default:
        ...
        if(defaultImageSource){
          return <Image source={defaultImageSource} style={this.state.avatarStyle} />
        }
      }
    ...
    if (this.state.title != null) {
      return (
        <Text
          ...
          style={[this.state.titleStyle, {color: this.state.messageColor}]}>
          {this.state.title}
        </Text>
      )
    }
